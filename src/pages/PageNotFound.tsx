import bgImage from "../assets/alone.webp";

const PageNotFound = () => {
  return (
    <div className="relative h-screen overflow-hidden bg-indigo-900">
          <img src={bgImage} className="absolute h-full w-full object-cover" /> 
      ...
      <div className="container relative z-10 mx-auto flex items-center px-6 py-32 md:px-12 xl:py-40">
        ...
        <div className="relative z-10 flex w-full flex-col items-center font-mono">
          ...
                     {" "}
          <p className="my-44  text-8xl font-extrabold text-white">
                            404            {" "}
          </p>
                 {" "}
        </div>
